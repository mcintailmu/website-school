	  ...
	  <div class="info-data" data-infodata="<?php if(isset($_SESSION['info'])){ echo $_SESSION['info']; } unset($_SESSION['info']); ?>"></div>
		...
		<div class="kotak">
			<form class="form-signin" action="proses.php" method="post" >
				<img src="img/logomci.png" alt="SPP Login" width="50px" height="50px" style="margin-left:25px;">

				<div style="margin-left:90px;margin-top:-35px;font-size:22px; margin-bottom:15px;">Aplikasi SPP</div>
