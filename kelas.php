...
<div class="container">
  <div class="row">
    <div class="col-10">
			<h2>Rekapitulasi Master Kelas</h2>
			<hr>
			...
			<div class="modal-body">
				<form action="kelas-simpan.php" method="post">
					...
					<div class="input-group mb-1">
						...
						<input type="text" name="nama_kelas" required autocomplete="off" class="form-control form-control-sm" placeholder="Jenjang">
					</div>
			
					<!-- Kompetensi Keahlian -->
					<div class="input-group mb-1">
						<span class="input-group-text lebar" >Jenjang</span>
