			...
			<form action="kelas-update.php" method="post">
				...
				<div class="input-group mb-2">
					...
					<select name="kelas" required class="form-control form-control-chosen">
						<option value="I" <?php if($kelas=='1'){echo 'selected="selected"';}?>>Kelas 1</option>
						<option value="II" <?php if($kelas=='2'){echo 'selected="selected"';}?>>Kelas 2</option>
						<option value="III" <?php if($kelas=='3'){echo 'selected="selected"';}?>>Kelas 3</option>
				...
				<div class="input-group mb-1 input-sm">
					<span class="input-group-text lebar" >Tahun Ajar</span>
				...
				<div class="input-group mb-1">
					<span class="input-group-text lebar" >Nama Jenjang</span>
